...
public:
	...
	void TriggerCheckDetectedBy(RE::TESObjectREFR* refr);
...
private:
	...
	SKSE::RegistrationSet<RE::TESObjectREFR*, int, int, bool, bool, bool, float> m_onHarvest;
	...
	SKSE::RegistrationSet<RE::TESObjectREFR*> m_onCheckDetectedBy;
};