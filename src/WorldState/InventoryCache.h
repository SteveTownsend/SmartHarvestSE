...
public:
  ...
  InventoryEntry(RE::TESBoundObject *item,
...
private:
  ...
  bool m_crafting;
  int m_count;
  mutable int m_totalDelta; // number of items assumed added by loot requests
...
typedef std::unordered_map<const RE::TESBoundObject *, InventoryEntry>
    InventoryCache;
